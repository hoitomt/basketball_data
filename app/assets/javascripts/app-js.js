...
"use strict";
eval("\n\nvar _VoiceRecorder = __webpack_require__(/*! ./VoiceRecorder */ \"./app-js/VoiceRecorder.js\");\n\nvar lib = function lib() {\n\n  function sum(a, b) {\n    return a + b;\n  }\n  function mult(a, b) {\n    return a * b;\n  }\n\n  return {\n    sum: sum,\n    mult: mult\n  };\n};\n\ndocument.addEventListener(\"turbolinks:load\", _VoiceRecorder.voiceRecorderinit);\n\n//# sourceURL=webpack:///./app-js/index.js?");
